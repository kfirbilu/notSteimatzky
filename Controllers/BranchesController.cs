...
namespace BooksStore.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public BranchesController(BooksStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Search(string Name, string City, string Address)
        {
            var query = from b in _context.Branches
                        where EF.Functions.Like(b.BranchName, "%" + Name) &&
                              EF.Functions.Like(b.City, "%" + City) &&
                              EF.Functions.Like(b.Address, "%" + Address)
                        select new { id = b.BranchId, name = b.BranchName, city = b.City, address = b.Address, phoneNumber = b.PhoneNumber};
